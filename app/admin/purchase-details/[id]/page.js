...
const PurchaseDetails = ({ params }) => {
  ...
  const { data: purchase } = useAsync(getPurchase, [purchaseId], [purchaseId]);
        ...
        <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
          <div className="space-y-3">
            ...
            <div className="space-y-1 rounded p-3 shadow">
              ...
              <p className="text-gray-800">
                {purchase?.data?.purchasePrice} Naira
              </p>
            </div>
            <div className="space-y-1 rounded p-3 shadow">
              <h2 className="text-md font-semibold">Selling Price</h2>
              <p className="text-gray-800">
                {purchase?.data?.sellingPrice} Naira
              </p>
            </div>
            <div className="space-y-1 rounded p-3 shadow">
              <h2 className="text-md font-semibold">Total Price</h2>
              <p className="text-gray-800">{purchase?.data?.totalPrice} Naira</p>
            </div>
          </div>
